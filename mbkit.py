...
def style(argument):
	...
	while x <= len(args):
		...
		# Bold
			...
			string = f"{string}\x1b[1m"
			args = args[1:]
		# Remove Bold
		elif arg1 == "-rmb":
			string = f"{string}\x1b[21m"
			args = args[1:]
		
		# Italics
		elif arg1 == "-i":
			string = f"{string}\x1b[3m"
			args = args[1:]
		# Remove italics
		elif arg1 == "-rmi":
			string = f"{string}\x1b[23m"
			args = args[1:]
