...
def style(argument):
    ...
    while x <= len(args):
        ...
        # Bold
            ...
            string = re.sub(r"-b ", "\x1b[1m", string, count=1)
            args = args[1:]
        # Remove Bold
        elif arg1 == "-rb":
        ...
        # Single Quotes
            ...
            quotes = f"{save}'"
            string = re.sub(r" -rq", quotes, string, count=1)
            args = args[1:]
...
if __name__ == "__main__":
    print(style("- -- -n -x rgb(0,150,75) -b -c rgb(255, 255, 255)  Yes  -rc -x rgb(150,0,0)  No! "))
    print(style("-b -c rgb(0, 125, 250) Hello World!"))
    print(style("-b -u Hello World!"))
    print(style("-b -u -x yellow -c red Hello -ru --fg blue World! -c red Now "))
